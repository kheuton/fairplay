/**
 * FAIRPLAY · Supply icon family.
 * 24×24 grid, stroke 1.4, square caps/miter joins.
 * Icon keys match ICON_LIB keys in design/prototype/icons.jsx exactly
 * so Todoist metadata references resolve correctly.
 */
...
export const IconCompostbag = makeIcon('Compost Bag', <>
...
export const IconWaterfilter = makeIcon('Water Filter', <>
...
export const IconTablets = makeIcon('Tablets (Motrin)', <>
...
export const IconCapsules = makeIcon('Capsules (Tylenol)', <>
  <rect x="8" y="4.6" width="8" height="2.8"/>
  <rect x="8.8" y="7.4" width="6.4" height="12.2"/>
  <path d="M8.8 10.4 H15.2" opacity=".5"/>
...
export const IconBlister = makeIcon('Blister Pack (Zyrtec)', <>
  <rect x="5" y="7.4" width="14" height="11.2"/>
  <circle cx="8.8" cy="11" r="1.5"/>
  <circle cx="15.2" cy="11" r="1.5"/>
  <circle cx="8.8" cy="15" r="1.5"/>
  <circle cx="15.2" cy="15" r="1.5"/>
  <path d="M12 7.4 V18.6" opacity=".5" strokeDasharray="1.6 1.6"/>
</>);

export const IconDrops = makeIcon('Drops (Probiotic)', <>
...
export const IconFormula = makeIcon('Formula Canister', <>
...
export const IconShampoo = makeIcon('Pump Bottle (Shampoo)', <>
...
export const IconConditioner = makeIcon('Squeeze Bottle (Conditioner)', <>
  <path d="M8 4 H16 V13.8 L14.4 16.4 H9.6 L8 13.8 Z"/>
  <rect x="10" y="16.4" width="4" height="3.4"/>
  <path d="M8 8 H16" opacity=".4"/>
</>);

export const IconCradlecap = makeIcon('Cradle Cap (Jar + Comb)', <>
  <path d="M8 4.4 H16"/>
...
export const IconSunscreen = makeIcon('Sunscreen', <>
...
export const IconPlasticwrap = makeIcon('Plastic Wrap', <>
  <rect x="4.5" y="12.6" width="15" height="5.8"/>
  <circle cx="7" cy="15.5" r="1.1" opacity=".5"/>
  <path d="M10 12.6 C10 9 14 10.4 14 6.4"/>
</>);

export const IconFoil = makeIcon('Aluminum Foil', <>
  <rect x="4.5" y="12.6" width="15" height="5.8"/>
  <circle cx="7" cy="15.5" r="1.1" opacity=".5"/>
  <path d="M9.5 12.6 V9 L11.3 10.6 L13.1 9 L14.9 10.6 L16.7 9 V12.6"/>
</>);

export const IconParchment = makeIcon('Parchment Paper', <>
  <rect x="4.5" y="12.6" width="15" height="5.8"/>
  <circle cx="8.4" cy="9.4" r="2"/>
  <path d="M10.4 9.4 H16.6 V12.6"/>
</>);

export const IconGeneric = makeIcon('Generic Supply', <>
  <rect x="5" y="5" width="14" height="14"/>
  <path d="M5 12 H19 M12 5 V19" opacity=".4"/>
</>);

// Map icon key -> component (keys match prototype ICON_LIB exactly)
export const ICON_LIB: Record<string, React.ComponentType<IconProps>> = {
  diaper:      IconDiaper,
  wipes:       IconWipes,
  cream:       IconCream,
  trashbag:    IconTrashbag,
  compostbag:  IconCompostbag,
  waterfilter: IconWaterfilter,
  tablets:     IconTablets,
  capsules:    IconCapsules,
  blister:     IconBlister,
  drops:       IconDrops,
  formula:     IconFormula,
  shampoo:     IconShampoo,
  conditioner: IconConditioner,
  cradlecap:   IconCradlecap,
  sunscreen:   IconSunscreen,
  tp:          IconTp,
  papertowel:  IconPapertowel,
  ziplock:     IconZiplock,
  plasticwrap: IconPlasticwrap,
  foil:        IconFoil,
  parchment:   IconParchment,
  generic:     IconGeneric,
};
...
export function ItemIcon({ name, size = 28 }: ItemIconProps) {
